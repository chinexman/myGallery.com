...
*/
    ...
    if(!$error) {
        $sql = "INSERT INTO users".
            "(userName,userEmail,userPass,hash) "."VALUES ".
...
/*
        ...
        /*    $to = $email;
            ...
            Thank you for signing up!
             ...
             http://localhost/mygallery.com/verify.php?email='.$email.'&hash='.$hash;
...
<div class="container text-center">
    ...
    <div id="login-form text-center">
      ...
      +              </div>
                ...
                <div class="form-group">
                    <a href="gallogin.php">Sign in Here...</a>
                </div>
...
<?php echo $Email; ?>
<?php echo $hash; ?>
<button type="button"><a href="verify.php?email='chinexdiamond@gmail.com'. hash='13f3cf8c531952d72e5847c4183e6910';">send email
    </a></button>
<br>
