    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#myPage">
                <img src="../myGallery.com/IMG/camera.png"  style="border-radius:5px" alt="logo" width="45" height="45">
...
$sqli = "select * from upload_image where userId=".$_SESSION['user'];
...
while ($row = $result->fetch_assoc()) {
  ...
  <div class="gallery">
    <a target="_blank" href="<?php echo $path; ?>">
        ...
        echo "<img src='$path'  class='photo' height='458' width='306'/>";
      ...
      <div class="desc">
          <a href="delete.php?imageid=<?php echo $row['imageid']; ?>"><button type="button" class="delete">delete</button></a>
