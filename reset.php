...
if($password!=$conpassword){
    ...
    if(!$error){
        ...
        if($res){
            $errMsg="your password have been reset, proceed to login";
        }else{
            ...
            <div class="col-md-12">
                ...
                <div class="form-group text-center">
                    <div class="input-group">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="Your Email" value="<?php echo $_GET['email']; ?>" maxlength="40" />
                    </div>
                ...
                <div class="form-group text-center">
                    <div class="input-group">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                        <input type="password" name="conpassword" class="form-control" placeholder="confirm Password" maxlength="15" />
                    </div>
                    <span class="text-danger"><?php echo $passError1; ?></span>
                </div>
                <div class="form-group">
                    <hr />
                </div>
                ...
                <div class="form-group text-center">
                    <button type="submit" class="btn btn-block btn" name="reset">reset</button>
                </div>
