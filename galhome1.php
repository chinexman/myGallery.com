...
if(isset($_FILES['image'])){
    ...
    for($i=0; $i<count($_FILES['image']['name']); $i++ ){
        ...
        $target_path= $UPLOADDIR.basename($_FILES['image']['name'][$i]);
        ...
        if(empty($error)==true){
            ...
            if(move_uploaded_file($file_tmp,$image_file)){
                ...
                $sql = "INSERT INTO upload_image(path,userId) values('$target_path','$userId')";
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#myPage">
                <img src="../myGallery.com/IMG/camera1.png"  style="border-radius:5px" alt="logo" width="45" height="45">
...
<!-- end jumbutron -->
        ...
        <h3>start uploading yours photos</h3>
<!-- about company page -->
<form action="" method="post" enctype="multipart/form-data">
   <!--<input type="file" name="image">-->
     <input type="file" name="image[]" id="images" multiple>

    <input type="submit" name="btn-upload" class="btn-warning" value="upload ">
               ...
               <h3> click on the button to view uploaded photos</h3>
<br>
    <a href="checkhome.php"> <button type="submit" name="view" class="btn-danger ">View Gallery
            </button></a>
...
<div id="contact" class="container-fluid bg-grey">
    ...
    <form class="row" method="post" action="" autocomplete="off">
        <div class="col-sm-5">
            ...
            <p> <span class="glyphicon glyphicon-map-maker"></span>Nigeria</p>
...
<footer class="container-fluid center-text">
    ...
    <p>Bootstrap Theme Made By <a href="http://www.myGallery.com.ng" title="Visit myGallery">www.myGallery.com.ng</a> </p>
